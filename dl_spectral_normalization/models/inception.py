...
def inception_miyato_sn(input_data, num_classes=10, wd=0, update_collection=None, beta=1., reuse=None, training=False, bn=True):
    ...
    snconv_kwargs = dict(update_collection=update_collection, beta=beta,
                         reuse=reuse, training=training, bn=False, tighter_sn=False)
