...
def vgg(NUM_CLASSES, wd=0, update_collection=None):
    """VGG architecture"""
...
def vgg_sn(NUM_CLASSES, wd=0, update_collection=None):
    ...
    layer14 = sn.linear(layer13, 512, scope_name='linear14', xavier=True, update_collection=update_collection)
    fc = sn.linear(layer14, NUM_CLASSES, scope_name='fc', xavier=True, update_collection=update_collection)

    return input_data, input_labels, fc


def vgg_sar(NUM_CLASSES, wd=0, update_collection=None):
