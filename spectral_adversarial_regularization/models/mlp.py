...
def mlp1(NUM_CLASSES, wd=0, update_collection=None, beta=1.):
...
def mlp1_sn(NUM_CLASSES, wd=0, update_collection=None, beta=1.):
...
def mlp1_sar(NUM_CLASSES, wd=0, update_collection=None, beta=1.):
...
def mlp3(NUM_CLASSES, wd=0, update_collection=None, beta=1.):
...
def mlp3_sn(NUM_CLASSES, wd=0, update_collection=None, beta=1.):
    """1-hidden-layer Multilayer Perceptron architecture with spectral normalization on all layers"""
...
def mlp3_sar(NUM_CLASSES, wd=0, update_collection=None, beta=1.):
